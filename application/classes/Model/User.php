...
class Model_User extends ORM {
    ...
    */
    public function get_basket()
    {
        ...
        $query = DB::query(Database::SELECT, "SELECT SUM(quantity) AS total_count, SUM(actual_price*quantity) AS summa FROM {$orders_table} WHERE user_id = {$this->uid} AND status = 0");
